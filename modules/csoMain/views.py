...
def login():
	...
	if "username" in session:
		...
		key = getAppKey(apps) # recuperation de la clef
		jsonValues, signature = signedTab(values, key) # Calcul de la signature et preparation de l'array pour le mettre dans le POST
		b64jsonValues = base64.b64encode(jsonValues) # Calcul de la base64 de l'arrayJson
